package com.sihabudin.itask.history.viewModel
...
class HistoryViewModel(val taskUseCase: TaskUseCase) : ViewModel() {
    fun getTaskHistory() = LiveDataReactiveStreams.fromPublisher(taskUseCase.getTaskHistory())
