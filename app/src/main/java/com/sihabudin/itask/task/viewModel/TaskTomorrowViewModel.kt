package com.sihabudin.itask.task.viewModel
...
class TaskTomorrowViewModel(val taskUseCase: TaskUseCase) : ViewModel() {
    fun getTaskTomorrow() = LiveDataReactiveStreams.fromPublisher(taskUseCase.getTaskTomorrow())
