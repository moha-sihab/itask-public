...
class TaskNextWeekViewModel(val taskUseCase: TaskUseCase) : ViewModel() {
    fun getTaskNextWeek() = LiveDataReactiveStreams.fromPublisher(taskUseCase.getTaskNextWeek())
