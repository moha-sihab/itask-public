package com.sihabudin.itask.search.viewModel
...
class SearchViewModel (val taskUseCase: TaskUseCase) : ViewModel() {
    fun getSearchTask(title:String) = LiveDataReactiveStreams.fromPublisher(taskUseCase.getSearchTask(title))
